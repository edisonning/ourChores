...
- 新增 12 项系统任务，包含擦餐桌、厨房台面、吸尘拖地、卫浴清洁、换床品、冰箱整理等，奖励 1～5 颗糖果；按每日、每周或按需安排，默认不指定成员。更新并重启服务后，新老数据库均补充一次，已有同名任务（含已删除）不会重复添加。
- 完成任务 → 对方确认 → 攒糖果积分（不能自己确认自己，防刷分）
- 心愿清单：用糖果兑换，对方兑现
- 系统预设涵盖美食、陪伴与休息：零食、咖啡、爱心早餐、游戏时间、惊喜约会等；新增 12 项为 10～100 颗糖果。服务更新并重启后自动补充到网页版和小程序的心愿清单，可直接兑换或删除；不重复添加，也不恢复已删除的同名心愿。
- 家务天平：按本周／本月已确认的家务积分展示双方分担，付出更多的一侧下沉；保留积分、完成件数与差值，兑换心愿不影响天平。网页版和小程序入口均为「天平」。
